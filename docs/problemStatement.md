...
- Collect **10–15 official public URLs**, including:
  - Scheme factsheets
...
- **Target Schemes (Groww Reference Context)**:
...
- Fund management details (fund managers, experience, tenure, and AUM/fund size)

#### Response Formatting Constraints
- **Length**: Each response is limited to a maximum of **3 sentences**.
- **Citations**: Each response must include **exactly one citation link**.
- **Footer**: Each response must include a footer:
